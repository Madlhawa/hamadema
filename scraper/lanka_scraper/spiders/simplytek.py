...
class SimplytekSpider(scrapy.Spider):
    name = "simplytek"
    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            url = f"https://www.simplytek.lk/products/{product.get('handle')}"
        ...
        if len(products) == 250:
            ...
            next_url = f"https://www.simplytek.lk/products.json?limit=250&page={next_page}"
