...
class BuyabansSpider(scrapy.Spider):
    name = "buyabans"
    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            url = f"https://buyabans.com/products/{product.get('handle')}"
        ...
        if len(products) == 250:
            ...
            next_url = f"https://buyabans.com/products.json?limit=250&page={next_page}"
